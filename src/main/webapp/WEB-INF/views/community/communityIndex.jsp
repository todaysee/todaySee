					...
					<div class="news-feed-area">
								...
								<div class="dropdown">
									...
									<ul class="dropdown-menu">
										<li><a class="dropdown-item d-flex align-items-center"
											href="#"><i class="flaticon-edit"></i> Edit Post</a></li>
										<li><a class="dropdown-item d-flex align-items-center"
											href="#"><i class="flaticon-private"></i> Hide Post</a></li>
										<li><a class="dropdown-item d-flex align-items-center"
											href="#"><i class="flaticon-trash"></i> Delete Post</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="post-body">
								...
								<ul
									...
									<li class="post-react"><a href="#"><i
										...
										<ul class="react-list">
											<li><a href="#"><img
													src="/images/mypageCommunity/react/react-1.png" alt="Like"></a>
											</li>
											<li><a href="#"><img
													src="/images/mypageCommunity/react/react-2.png" alt="Like"></a>
											</li>
											<li><a href="#"><img
													src="/images/mypageCommunity/react/react-3.png" alt="Like"></a>
											</li>
											<li><a href="#"><img
													src="/images/mypageCommunity/react/react-4.png" alt="Like"></a>
											</li>
											<li><a href="#"><img
													src="/images/mypageCommunity/react/react-5.png" alt="Like"></a>
											</li>
											<li><a href="#"><img
													src="/images/mypageCommunity/react/react-6.png" alt="Like"></a>
											</li>
											<li><a href="#"><img
													src="/images/mypageCommunity/react/react-7.png" alt="Like"></a>
											</li>
										</ul></li>
						...
						<div class="news-feed news-feed-post">
							<div
								...
								<div class="image">
									<a href="my-profile.html"><img
										src="/images/mypageCommunity/user/user-36.jpg"
										class="rounded-circle" alt="image"></a>
								</div>
								<div class="info ms-3">
									<span class="name"><a href="my-profile.html">Maria
											Dodson</a></span> <span class="small-text"><a href="#">2
											Hours Ago</a></span>
								</div>
								<div class="dropdown">
									<button class="dropdown-toggle" type="button"
							...
							<div class="post-body">
								<p>Keep Smiling 🧡</p>
								<div class="post-image">
									<img src="/images/mypageCommunity/news-feed-post/post-3.jpg"
										alt="image">
								</div>
								<ul
									class="post-meta-wrap d-flex justify-content-between align-items-center">
								...
								<form class="post-footer">
									<div class="footer-image">
										<a href="#"><img
											src="/images/mypageCommunity/user/user-15.jpg"
											class="rounded-circle" alt="image"></a>
									</div>
									<div class="form-group">
										<textarea name="message" class="form-control"
						...
						<div class="news-feed news-feed-post">
							<div
								...
								<div class="image">
									<a href="my-profile.html"><img
										src="/images/mypageCommunity/user/user-5.jpg"
										class="rounded-circle" alt="image"></a>
								</div>
								<div class="info ms-3">
									<span class="name"><a href="my-profile.html">Karen
											Williams</a></span> <span class="small-text"><a href="#">10
											Mins Ago</a></span>
								</div>
								<div class="dropdown">
									<button class="dropdown-toggle" type="button"
							...
							<div class="post-body">
								<p>Donec rutrum congue leo eget malesuada. Nulla quis lorem
									...
									malesuada.</p>
								<div class="post-image">
									<img src="/images/mypageCommunity/news-feed-post/post-4.jpg"
										alt="image">
								</div>
								<ul
									class="post-meta-wrap d-flex justify-content-between align-items-center">
								...
								<div class="post-comment-list">
									<div class="comment-list">
										<div class="comment-image">
											<a href="my-profile.html"><img
												src="/images/mypageCommunity/user/user-14.jpg"
												class="rounded-circle" alt="image"></a>
										</div>
										<div class="comment-info">
											<h3>
									...
									<div class="comment-list">
										<div class="comment-image">
											<a href="my-profile.html"><img
												src="/images/mypageCommunity/user/user-16.jpg"
												class="rounded-circle" alt="image"></a>
										</div>
										<div class="comment-info">
											<h3>
								...
								<form class="post-footer">
									<div class="footer-image">
										<a href="#"><img
											src="/images/mypageCommunity/user/user-19.jpg"
											class="rounded-circle" alt="image"></a>
									</div>
									<div class="form-group">
										<textarea name="message" class="form-control"
						...
						<div class="news-feed news-feed-post">
							<div
								...
								<div class="image">
									<a href="my-profile.html"><img
										src="/images/mypageCommunity/user/user-18.jpg"
										class="rounded-circle" alt="image"></a>
								</div>
								<div class="info ms-3">
									<span class="name"><a href="my-profile.html">Maria
							...
							<div class="post-body">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
									...
									aliqua.</p>
								<div class="post-image">
									<img src="/images/mypageCommunity/news-feed-post/post-5.jpg"
										alt="image">
								</div>
								<ul
									class="post-meta-wrap d-flex justify-content-between align-items-center">
								...
								<form class="post-footer">
									<div class="footer-image">
										<a href="#"><img
											src="/images/mypageCommunity/user/user-22.jpg"
											class="rounded-circle" alt="image"></a>
									</div>
									<div class="form-group">
										<textarea name="message" class="form-control"
