  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
		<form action="/admin/communityReportWork/${communityReport.communityReportNumber}" method="post">
                ...
                <ul class="nav nav-pills flex-column">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      ...
                      <span class="float-right">${communityReport.user.userEmail }</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      <i class="far fa-file-alt"></i> 이름 
                       <span class="float-right">${communityReport.user.userName }</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      <i class="fas fa-filter"></i> 신고 날짜
                      <span class=" bg-warning float-right"><fmt:formatDate value="${communityReport.communityReportDate}" pattern="yyyy-MM-dd"/>
                   </span>
                    </a>
                  </li>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5>${communityReport.user.userName }</h5>
                <h6>${ communityReport.user.userEmail}
              ...
              <div class="mailbox-read-message">
                <pre>커뮤니티 제목 :		 ${communityReport.community.communityTitle }</pre>
				 <div class="mailbox-controls with-border text-center">
				 
				 </div>
                <pre class="communityContent">내용 :	 ${communityReport.community.communityContent }</pre>
					 <div class="mailbox-controls with-border text-center">
