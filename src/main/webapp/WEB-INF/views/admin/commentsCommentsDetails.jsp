  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
		<form action="/admin/commentsCommentsReportWork/${commentsCommentsReport.commentsCommentsReportNumber}" method="post">
                ...
                <ul class="nav nav-pills flex-column">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      ...
                      <span class="float-right">${commentsCommentsReport.user.userEmail }</span>
                    </a>
                  </li>
                 <li class="nav-item">
                    <a href="#" class="nav-link">
                      <i class="far fa-file-alt"></i> 이름 
                       <span class="float-right">${commentsCommentsReport.user.userName }</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5>${commentsCommentsReport.user.userName }</h5>
                <h6>${ commentsCommentsReport.user.userEmail}
              ...
              <div class="mailbox-read-message">
                <pre>댓글 내용 :	${commentsCommentsReport.commentsComments.comments.commentsContent }</pre>
				 <div class="mailbox-controls with-border text-center">
				 
				 </div>
                <pre class="communityContent">대댓글 내용 :	 ${commentsCommentsReport.commentsComments.commentscomments_content }</pre>
					 <div class="mailbox-controls with-border text-center">
				 
				 </div>
                <div class="mailbox-read-message communityContent">
               <pre>신고 사유 : ${commentsCommentsReport.commentsCommentsReportContent }</pre>
