                        ...
                        <div class="dropdown friend-requests-nav-item">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="friend-requests-body" data-simplebar>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-3.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-4.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-5.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-6.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-7.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-8.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-9.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="messages-body" data-simplebar>
                                    <div class="item d-flex justify-content-between align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-11.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                        <div class="text">
                                    ...
                                    <div class="item d-flex justify-content-between align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-12.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                        <div class="text">
                                    ...
                                    <div class="item d-flex justify-content-between align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-13.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                        <div class="text">
                                    ...
                                    <div class="item d-flex justify-content-between align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="/images/mypageCommunity/user/user-14.jpg" class="rounded-circle" alt="image"></a>
                                        </div>
                                        <div class="text">
                        ...
                        <div class="dropdown language-option">
                            ...
                            <div class="dropdown-menu language-dropdown-menu">
                                <a class="dropdown-item" href="#">
                                    <img src="/images/mypageCommunity/uk.png" alt="flag">
                                    Eng
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="/images/mypageCommunity/china.png" alt="flag">
                                    简体中文
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="/images/mypageCommunity/uae.png" alt="flag">
                                    العربيّة
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="dropdown profile-nav-item">
                            <a href="#" class="dropdown-bs-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="menu-profile">
                                    <img src="/images/mypageCommunity/user/user-1.jpg" class="rounded-circle" alt="image">
